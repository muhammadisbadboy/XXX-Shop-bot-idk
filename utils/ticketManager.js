...
module.exports = {
  ...
  async createTicket(client, guild, ticketName, creatorId, otherUserInput) {
    ...
    const overwrites = [
      ...
      { id: claimRole.id, allow: [PermissionFlagsBits.ViewChannel, PermissionFlagsBits.SendMessages] }, // CLAIM role
    ];
  ...
  async closeTicket(ticketChannel, guild) {
    const TICKET_TRANSCRIPTS_ID = '1478762582994059305'; // Hardcoded transcripts channel
